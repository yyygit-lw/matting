...
def priormatting(Img,Trimap_real,Img_file):
    ...
    #show(Img)
    Trimap=pre_proces(Trimap_real,thr_C=4,thr_E=4)
    show(Trimap)
...
if __name__ == "__main__":
    ...
    save_path="/home/ybw/matting/output/training/"
    cv2.imwrite(save_path+"samp/"+Trimap_cls+'/'+Img_file, alpha_samp)#save_path+"samp/"+Trimap_cls+'/'+
    cv2.waitKey(0)
    cv2.imwrite( save_path+"weight/"+Trimap_cls+'/'+Img_file , alpha_weight)
    cv2.waitKey(0)